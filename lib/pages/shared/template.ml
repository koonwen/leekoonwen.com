...
let navbar (selected : page) =
  ...
  [ nav
      ...
      [ a
          ...
          [ txt "About" ]
      ; a
          ~a:[ a_class [ navtext_class Projects; "ripple" ]; a_href "/projects.html" ]
          [ txt "Projects" ]
      ; a ~a:[ a_class [ navtext_class CV; "ripple" ]; a_href "/cv.html" ] [ txt "CV" ]
      ; a
          ~a:[ a_class [ navtext_class Contact; "ripple" ]; a_href "/contact.html" ]
          [ txt "Contact" ]
      ]
  ]
;;
      ...
      [ table
          ...
          ; tr
              ...
              ; th
                  ~a:[ a_class [ "th-link" ] ]
                  [ a
                      ~a:[ a_href "https://www.linkedin.com/in/koonwen-lee-b349b1175/" ]
